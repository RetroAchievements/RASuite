...
/// </summary>
/// <param name="GameProgressOut"></param>
void ParseMyProgressFromFile(std::map<GameID, std::string>& GameProgressOut)
{
	FILE* pf = fopen(RA_MY_PROGRESS_FILENAME, "rb");
...
#pragma region C4800 Performance Warning
						bool bResult = ReadFile(hROMReader, sROMRawData, nSize, &nBytes, NULL);  // C4800
#pragma endregion
