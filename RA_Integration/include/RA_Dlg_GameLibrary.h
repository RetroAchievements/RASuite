...
public:
	...
	Dlg_GameLibrary(Dlg_GameLibrary&&) = default;
	Dlg_GameLibrary& operator=(Dlg_GameLibrary&&) noexcept = default;
	...
	void KillThread();
	HWND GetWindow() const noexcept { return m_hGameLibWnd; }
...
protected:
	...
	/// <inheritdoc />
	void OnTimer(HWND hwnd, _UNUSED UINT id) override;
