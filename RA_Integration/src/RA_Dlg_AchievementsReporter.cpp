...
HWND Dlg_AchievementsReporter::GetWindow() const noexcept { 
...
void Dlg_AchievementsReporter::OnCommand(HWND hwnd, int id, _UNUSED HWND hwndCtl,
...
INT_PTR Dlg_AchievementsReporter::DialogProc(HWND hwnd, UINT uMsg,
