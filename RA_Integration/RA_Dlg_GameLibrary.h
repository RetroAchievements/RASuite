...
private:
	...
	static std::map<std::string, std::string> Results;			//	file-path,md5 (parsed/persisted)
	static std::map<std::string, std::string> VisibleResults;	//	file-path,md5 (added to renderable)
